...
if __name__=='__main__':
	...
	print(calculate_precision_recall('train_summary_yes.txt', 'train_summary_yes_predict.txt'))
	print(calculate_precision_recall('test_summary_yes.txt', 'test_summary_yes_predict.txt'))
	# print(compute_iou([170, 226, 269, 257], [159, 334, 252, 377]))